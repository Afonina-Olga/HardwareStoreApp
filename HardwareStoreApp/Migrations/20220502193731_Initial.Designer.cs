...
namespace HardwareStoreApp.Migrations
{
    ...
    [Migration("20220502193731_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HardwareStoreApp.Models.Sale", b =>
                {
                    b.HasOne("HardwareStoreApp.Models.Balance", "Balance")
                        .WithMany()
            ...
            modelBuilder.Entity("HardwareStoreApp.Models.Store", b =>
                {
                    b.HasOne("HardwareStoreApp.Models.Balance", "Balance")
                        .WithOne("Store")
                        .HasForeignKey("HardwareStoreApp.Models.Store", "BalanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HardwareStoreApp.Models.Sale", "Sale")
                        .WithOne("Store")
                        .HasForeignKey("HardwareStoreApp.Models.Store", "SaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
